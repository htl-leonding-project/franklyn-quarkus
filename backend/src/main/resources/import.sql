insert into f_examiner (id ,e_user_name, e_first_name, e_last_name, e_is_admin)
    values (1, 'tmelch', 'Tamara', 'Melcher', true);
insert into f_examiner (id ,e_user_name, e_first_name, e_last_name, e_is_admin)
    values (2, 'mtran', 'Michael', 'Tran', true);
insert into f_examiner (id ,e_user_name, e_first_name, e_last_name, e_is_admin)
    values (3, 'tstuet', 'Thomas', 'Stütz', true);
...
insert into f_examinee (id, e_first_name, e_last_name)
values (1, 'Max', 'Mustermann');
insert into f_examinee (id, e_first_name, e_last_name)
values (2, 'Maxine', 'Musterfrau');

insert into f_exam_f_examinee (exam_id, examineeids_id)
    values ( 1, 1);
insert into f_exam_f_examinee (exam_id, examineeids_id)
    values (1, 2);
